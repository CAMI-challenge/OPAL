...
TOOLTIP_FN = "number of taxa incorrectly predicted as being absent at the selected taxonomic rank"
TOOLTIP_OTUS = "number of predicted taxa at the selected taxonomic rank"
TOOLTIP_JACCARD = "indicator of similarity between the sets of true and predicted taxa at the seletec taxonomic rank computed as the ratio of the number of taxa in the intersection of these sets to the number of taxa in their union"
